  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">School Requests</li>
      </ol>
    </section> <br><br>
         ...
         <div class="col-md-8 ">
           ...
           <div class="row text-center">
              <div class="col-md-6" style="margin-top:70px;">
               <img src="<?= $siteUrl ?>/edu-joy/asset/img/site-logo.jpeg" class="img-fluid img-circle" height="200" width="200">
              </div>
